...
Write-Host "   • Login:          http://localhost:3000/frontend/login.html"
Write-Host "   • Espace client:  http://localhost:3000/frontend/espace-client.html"
Write-Host "   • Admin:          http://localhost:3000/frontend/admin.html`n"
