...
echo    • Login:          http://localhost:3000/frontend/login.html
echo    • Espace client:  http://localhost:3000/frontend/espace-client.html
echo    • Admin:          http://localhost:3000/frontend/admin.html
echo.
echo 👤 Client de test:
