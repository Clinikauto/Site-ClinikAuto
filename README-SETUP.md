...
### ❌ "Impossible de contacter le serveur" sur file://...
→ Vous avez ouvert un fichier local (ex: `frontend/espace-client.html`) directement.
→ Lancez d'abord le serveur puis ouvrez: `http://localhost:3000/espace-client.html`
